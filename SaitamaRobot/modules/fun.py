...
import Romeo.modules.fun_strings as fun_strings
from Romeo import dispatcher
from Romeo.modules.disable import DisableAbleCommandHandler
from Romeo.modules.helper_funcs.chat_status import is_user_admin
from SRomeo.modules.helper_funcs.extraction import extract_user
from telegram import ChatPermissions, ParseMode, Update
from telegram.error import BadRequest
from telegram.ext import CallbackContext, run_async

GIF_ID = 'BAADBAADMgIAAnsePFLdX73tkq1o6wI'
...
def slap(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        temp = random.choice(fun_strings.SLAP_ROMEO_TEMPLATES)
